	...
	class category
	{
		...
		public function insert_category($catName){
			...
			if(empty($catName)){
				...
				if($result){
					...
					$alert = "<span class='error'>Thêm thất bại</span>";
					return $alert;
				}
			}
		}
		...
		public function update_category($catName,$id)
		{
			...
			if(empty($catName)){
				...
				if($result){
					$alert = "<span class='success'>Cạp nhật thành công</span>";
					return $alert;
				}else {
		...
		public function del_category($id)
		{
			...
			if($result){
				$alert = "<span class='success'>Xóa danh mục thành công</span>";
				return $alert;
			}else {
				$alert = "<span class='success'>Xóa danh mục thất bại</span>";
				return $alert;
			}
		}
